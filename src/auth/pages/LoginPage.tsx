  ...
  >
    ...
    <div style={{ flex: "2 1 300px", minWidth: "300px" }}>
      <Form form={form} layout="vertical" onFinish={onFinish}>
        <Form.Item label={<span style={{ color: "#333" }}>Correo electrónico</span>} name="email"
          rules={[
        ...
        <Form.Item label={<span style={{ color: "#333" }}>Contraseña</span>} name="password"
          rules={[
        ...
        <Form.Item>
          <Space direction="vertical" style={{ width: "100%" }}>
            {messageError && (
              <Text type="danger" style={{ display: "block", textAlign: "center", marginBottom: 10, color: "#cc3333" }}>
                {messageError}
              </Text>
            )}
            ...
            <Button icon={<GoogleOutlined />} onClick={handleGoogleLogin} block
              style={{ background: "#eaeaea", color: "#333", borderRadius: "8px" }}>
              Iniciar con Google
            </Button>
          </Space>
        </Form.Item>
